      ...
      connection.query("SELECT * FROM products WHERE item_id=?", userPurchase.inputId, function (err, res) {
        ...
        for (var i = 0; i < res.length; i++) {
          ...
          if (userPurchase.inputNumber > res[i].stock_quantity) {
            ...
            console.log("  ");
            console.log("======================================================");
            console.log("We do not have the item you requested in stock at that quantity.");
            console.log("Please start over and select a different quantity.");
            console.log("  ");
            console.log("======================================================");
            console.log("  ");
            ...
            console.log("  ");
            console.log("You selected " + userPurchase.inputNumber + " of the item " + res[i].product_name);

            console.log(" from " + res[i].department_name + " at $" + res[i].price + " each");
...
function confirmPrompt(newStock, purchaseId) {
  inquirer.prompt([{
    ...
    if (userConfirm.confirmPurchase === true) {
      ...
      console.log("  ");
      console.log("-----------------------------------------------------");
      console.log("Thank you. We hope to serve you again soon");
      console.log("-----------------------------------------------------");
      console.log("  ");
